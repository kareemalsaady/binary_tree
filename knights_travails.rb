    ...
    while current != nil || !stack.empty? do
      ...
      def dfs_rec(value, current_node)
        if current_node.value = value
          p "node found at #{current_node}"
        end
        if current_node.child_left != nil
          dfs_rec(value, current_node.child_left)
          return current_node.child_left
        elsif current_node.child_right != nil
          dfs_rec(value, current_node.child_right)
...
#p test
test.breadth_first_search(11)
test.dfs_rec(11, @root)
